...
namespace JornadaMilhas.Test
{
    public class GerenciadorDeOfertasRecuperaMaiorDesconto
    {
        ...
        [Fact]
        public void RetornaOfertaEspecificaQndoDestinoSPEDesconto40()
        {
            //Arrange
            ...
            var fakerOferta = new Faker<OfertaViagem>().CustomInstantiator(f => new OfertaViagem(rota, fakerPeriodo.Generate(), 100 * f.Random.Int(1, 100)))
